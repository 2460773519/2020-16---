...
void UART3_IRQHandler(void)
{
	...
	if(UART3->ISR & UART_ISR_RX_INTF)												// 串口接收缓冲中断
	{
             ...
             uart_getchar(UART_3,&opmv_data);
            beepds=5;
            
             s_p_mc=opmv_data;
             
             if((stop==0)&&(opmv_data!=0x11&&opmv_data!=0x12&&opmv_data!=0x13&&opmv_data!=0x14&&opmv_data!=0x15))
             {
...
//                 if(opmv_data==0x11&&fx_fx_fx==2)
//               {
//                 opmv_data=0x12;
//                 
//               }
//             
//                 if(opmv_data==0x12&&fx_fx_fx==1)
//               {
//                 opmv_data=0x11; 
//               }
...
{                  
	...
	{
             uart_getchar(UART_4,&wuxian_data);
        //  uart_getchar(UART_4,&opmv_data);
