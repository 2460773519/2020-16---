...
extern uint8 image_avg[MT9V03X_H][MT9V03X_W];
...
extern uint8 OTSU(uint8 *imgIn , uint8 Line , uint8 Line_end, uint8 Col_start , uint8 Col_end);
...
extern void find_side(uint8 p[ROW][COL]);
...
extern void avg_image();
extern void on_shizi();
extern void juy_banma_4();
//
#endif